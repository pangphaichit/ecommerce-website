...
export default function BlogList({ blogs, isFiltering }: BlogListProps) {
  ...
  useEffect(() => {
    const updateLength = () => {
      setTruncateLength(window.innerWidth >= 1024 ? 250 : 125);
    };
  ...
  return (
    <div className="grid gap-6 grid-cols-1 lg:grid-cols-3 mt-3 mb-6 lg:mt-6">
      {blogs.map((blog) => (
        <div className=" bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-shadow duration-200 group overflow-hidden cursor-pointer">
          <div
            key={blog.blog_id}
            className="flex flex-col h-122 lg:h-130 gap-4"
            ...
            <div className="px-4">
              ...
              <div className="relative w-full flex flex-col justify-start mt-4">
                <div className="flex flex-col">
                  <h3 className="text-lg lg:text-xl font-semibold text-yellow-700">
                    {blog.title}
                  </h3>
                </div>

                <p className="text-gray-600 text-base lg:text-lg my-4">
                  {blog.article.length > truncateLength
                    ? blog.article.slice(0, truncateLength) + "..."
                    : blog.article}
                </p>
              </div>
            </div>
          ...
          <div className="px-4">
            <div className="flex gap-3 items-center  my-4">
              ...
              <Image
                ...
                width={48}
                height={48}
                className="rounded-full object-cover w-8 h-8 lg:w-10 lg:h-10"
              />
              ...
              <div className="flex flex-row gap-2 justify-center">
                ...
                <span className="text-gray-500 text-xs lg:text-sm  border-r-2 border-gray-300 pr-2 ">
                  {blog.author_role
                    .split(" ")
            ...
            {/* Stats Bar */}
            <div className="flex items-center gap-4 text-xs lg:text-sm  text-gray-500 mt-4 pb-6 border-b border-gray-100">
            ...
            <div className="justify-between hidden lg:block">
              <div>
